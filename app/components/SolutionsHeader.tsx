  ...
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between whitespace-nowrap border-b border-primary-green/20 bg-background-light/80 px-10 py-4 backdrop-blur-sm dark:bg-background-dark/80">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold">Waste Grid</h1>
      </div>
      <nav className="hidden items-center gap-8 md:flex">
        <Link className="text-sm font-medium hover:text-primary-green" href="/">
          About
        </Link>
        <Link
      ...
      <div className="flex items-center gap-4">
        <button className="rounded-lg bg-primary px-5 py-2.5 text-sm font-bold text-white transition-transform hover:scale-105">
          Get Started
        </button>
      </div>
    </header>
